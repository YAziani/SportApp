...
public class Activity_FitnessFragebogen_rpt extends Activity_LineChartReports {
    ...
    protected void onStart() {
        super.onStart();
        computeDrawFive(addDays(new Date(), -4), new Date(), lineChart, Activity_FitnessFragebogen_rpt.this.getString
                                                            ...
                                                            if (!d.before(Startdate) && !d.after(EndDate)) {
                                                                ...
                                                                if (flag) {
                                                                    ...
                                                                    max_y = Math.max(y_Kraft, Math.max
                                                                            (y_Koordination, Math.max(y_Ausdauer,
                                                                                    Math.max(y_Gesamt, Math.max
                                                                                            (y_Beweglichkeit, max_y))
                                                                            )));
                                                                    min_y = Math.min(y_Kraft, Math.min
                                                                            (y_Koordination, Math.min(y_Ausdauer,
                                                                                    Math.min(y_Gesamt, Math.min
                                                                    ...
                                                                    flag = false;
                                                                    j++;
                                                                    y_Gesamt = y_Ausdauer = y_Beweglichkeit =
