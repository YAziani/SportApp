...
public class ActivityFitnessFragebogen extends AppCompatActivity {
    ...
    private void InitializeControlls() {
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.vom_Stuhl_aufstehen != null ?
                fitnessFragebogen.vom_Stuhl_aufstehen : -1);
        lststuhlaufstehen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .einen_schweren_Einkaufskorb_ueber_mehrere_Etagen_tragen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Einkaufskorb_tragen != null ?
                fitnessFragebogen.Einkaufskorb_tragen : -1);
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Kiste_tragen != null ?
                fitnessFragebogen.Kiste_tragen : -1);
        lstkistetragen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .aus_der_Rueckenlage_ohne_Hilfe_der_Arme_den_Oberkoerper_aufrichten));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Situp != null ? fitnessFragebogen
                .Situp : -1);
        lstsitup.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .einen_schweren_Koffer_ueber_Kopfhoehe_heben));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Koffer_hoch_heben != null ?
                fitnessFragebogen.Koffer_hoch_heben : -1);
        lstkofferheben.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .zwei_schwere_Koffer_ueber_mehrere_Etagen_tragen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Koffer_tragen != null ?
                fitnessFragebogen.Koffer_tragen : -1);
        lstkoffertragen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .eine_Hantel_mit_mehr_als_Ihrem_Koerpergewicht_hochstemmen));
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.flott_gehen != null ?
                fitnessFragebogen.flott_gehen : -1);
        lstflottgehen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .mehrere_Treppen_hochgehen_ohne_sich_auszuruhen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Treppen_gehen != null ?
                fitnessFragebogen.Treppen_gehen : -1);
        lsttreppengehen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .zwei_Kilometer_schnell_gehen_ohne_sich_auszuruhen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Zwei_km_gehen != null ?
                fitnessFragebogen.Zwei_km_gehen : -1);
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Ein_km_joggen != null ?
                fitnessFragebogen.Ein_km_joggen : -1);
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Dreißig_min_joggen != null ?
                fitnessFragebogen.Dreißig_min_joggen : -1);
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Sechzig_min_joggen != null ?
                fitnessFragebogen.Sechzig_min_joggen : -1);
        lst60minjoggen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string.einen_Marathon_laufen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Marathon != null ? fitnessFragebogen
                .Marathon : -1);
        lstmarathon.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .einen_engen_Pulli_und_Socken_alleine_aus_und_anziehen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Socken_anziehen != null ?
                fitnessFragebogen.Socken_anziehen : -1);
        lstanziehen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .auf_einem_Stuhl_sitzend_mit_den_Haenden_den_Boden_erreichen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Boden_im_Sitzen_beruehren != null ?
                fitnessFragebogen.Boden_im_Sitzen_beruehren : -1);
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Schuhe_binden != null ?
                fitnessFragebogen.Schuhe_binden : -1);
        lstschuhebinden.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .mit_der_Hand_von_unten_auf_dem_Ruecken_ein_Schulterblatt_beruehren));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Ruecken_beruehren != null ?
                fitnessFragebogen.Ruecken_beruehren : -1);
        lstrueckenberuehren.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .aus_dem_Stand_mit_den_Haenden_den_Boden_erreichen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Im_Stehen_Boden_beruehren != null ?
                fitnessFragebogen.Im_Stehen_Boden_beruehren : -1);
        lststehendboden.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .im_Stehen_mit_dem_Kopf_die_gestreckten_Knie_beruehren));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Mit_Kopf_das_Knie_beruehren != null ?
                fitnessFragebogen.Mit_Kopf_das_Knie_beruehren : -1);
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Bruecke != null ? fitnessFragebogen
                .Bruecke : -1);
        lstbruecke.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .eine_Treppe_hinab_gehen_ohne_sich_festzuhalten));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Treppe_runter_gehen != null ?
                fitnessFragebogen.Treppe_runter_gehen : -1);
        lsttrepperunter.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .auf_einem_Bein_stehen_ohne_sich_festzuhalten));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Einbeinstand != null ?
                fitnessFragebogen.Einbeinstand : -1);
        lsteinbeinstand.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string.einen_Purzelbaum));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Purzelbaum != null ?
                fitnessFragebogen.Purzelbaum : -1);
        ...
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Ball_prellen != null ?
                fitnessFragebogen.Ball_prellen : -1);
        lstballprellen.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .mit_Abstuetzen_ueber_einen_ein_Meter_hohen_Zaun_springen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Zaunsprung != null ?
                fitnessFragebogen.Zaunsprung : -1);
        lstzaunsprung.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string
                .freihaendig_mit_dem_Fahrrad_um_eine_Kurve_fahren));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Kurve_fahren_ohne_Hand != null ?
                fitnessFragebogen.Kurve_fahren_ohne_Hand : -1);
        lstkurveohnehand.setAdapter(adapter);

        adapter = new FitnessFragebogenViewAdapter(this);
        adapter.setFitnessFragebogen(fitnessFragebogen, getString(R.string.ein_Rad_schlagen));
        adapter.setSelectedIndex(fitnessFragebogen != null && fitnessFragebogen.Rad_schlagen != null ?
    ...
    public int kraftscoring() {
        kraftscore = scoringrechnung(lststuhlaufstehen.getIndexFitness()) + scoringrechnung(lsteinkaufskorb
                ...
                .getIndexFitness()) + scoringrechnung(lstkofferheben.getIndexFitness()) + scoringrechnung
                (lstkoffertragen.getIndexFitness()) + scoringrechnung(lsthantelstemmen.getIndexFitness());
        return kraftscore;
    }
    ...
    private int ausdauerscoring() {
        ausdauerscore = scoringrechnung(lstflottgehen.getIndexFitness()) + scoringrechnung(lsttreppengehen
                ...
                .getIndexFitness()) + scoringrechnung(lst30minjoggen.getIndexFitness()) + scoringrechnung
                (lst60minjoggen.getIndexFitness()) + scoringrechnung(lstmarathon.getIndexFitness());
    ...
    private int bewglichkeitsscoring() {
        beweglichkeitsscore = scoringrechnung(lstanziehen.getIndexFitness()) + scoringrechnung(lstsitzendboden
                ...
                (lstrueckenberuehren.getIndexFitness()) + scoringrechnung(lststehendboden.getIndexFitness()) +
                scoringrechnung(lstkopfknie.getIndexFitness()) + scoringrechnung(lstbruecke.getIndexFitness());
