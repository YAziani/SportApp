...
public class DiaryViewAdapterNew extends RecyclerView.Adapter<DiaryViewAdapterNew.DiaryEntryHolder> {
    ...
    public DiaryViewAdapterNew(List<DiaryEntry> diaryEntries, Activity context){
