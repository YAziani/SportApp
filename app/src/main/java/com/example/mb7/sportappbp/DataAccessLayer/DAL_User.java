...
public class DAL_User {
    ...
    static public void InsertStimmung(User user, StimmungsAngabe stimmungsAngabe) {
        try {
            ...
            Firebase ref = new Firebase(DAL_Utilities.DatabaseURL + "users/" + user.getName() + "/Stimmungsabfrage/"
    ...
    static public void InsertStimmungScore(User user, StimmungAbfrageScore stimmungAbfrageScore) {
        try {
            Firebase ref = new Firebase(DAL_Utilities.DatabaseURL + "users/" + user.getName() +
    ...
    static public void UpdateStimmungScore(User user, StimmungAbfrageScore stimmungAbfrageScore) {
        try {
